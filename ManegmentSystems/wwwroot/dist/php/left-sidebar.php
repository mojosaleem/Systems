            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="index.php"><i class="icon-home"></i><span class="hide-menu">Main </span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="index.php">Main</a></li>

                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"aria-expanded="false"><i class="ti-layout-grid2"></i><span class="hide-menu">Car </span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="Carmodels.php">Car Models</a></li>
                                <li><a href="CarManufacture.php">Car Manufacture</a></li>
                            </ul>
                        </li>
